...
> = {
  blue: {
    card: "bg-[var(--color-sd-blue-card)]",
    border: "border-[var(--color-sd-blue-border)]",
    title: "text-[var(--color-sd-blue-title)]",
    body: "text-[var(--color-sd-blue-body)]",
    chip: "bg-[var(--color-sd-blue-chip)] text-[var(--color-sd-blue-chip-fg)]",
  },
  amber: {
    card: "bg-[var(--color-sd-amber-card)]",
    border: "border-[var(--color-sd-amber-border)]",
    title: "text-[var(--color-sd-amber-title)]",
    body: "text-[var(--color-sd-amber-body)]",
    chip: "bg-[var(--color-sd-amber-chip)] text-[var(--color-sd-amber-chip-fg)]",
  },
  green: {
    card: "bg-[var(--color-sd-green-card)]",
    border: "border-[var(--color-sd-green-border)]",
    title: "text-[var(--color-sd-green-title)]",
    body: "text-[var(--color-sd-green-body)]",
    chip: "bg-[var(--color-sd-green-chip)] text-[var(--color-sd-green-chip-fg)]",
  },
  rose: {
    card: "bg-[var(--color-sd-rose-card)]",
    border: "border-[var(--color-sd-rose-border)]",
    title: "text-[var(--color-sd-rose-title)]",
    body: "text-[var(--color-sd-rose-body)]",
    chip: "bg-[var(--color-sd-rose-chip)] text-[var(--color-sd-rose-chip-fg)]",
  },
  slate: {
    card: "bg-[var(--color-sd-slate-card)]",
    border: "border-[var(--color-c-surface-cool-3)]",
    title: "text-[var(--color-c-text-3)]",
    body: "text-[var(--color-sd-slate-body)]",
    chip: "bg-[var(--color-sd-slate-chip)] text-[var(--color-sd-slate-chip-fg)]",
  },
  violet: {
    card: "bg-[var(--color-sd-violet-card)]",
    border: "border-[var(--color-sd-violet-border)]",
    title: "text-[var(--color-sd-violet-title)]",
    body: "text-[var(--color-sd-violet-body)]",
    chip: "bg-[var(--color-sd-violet-chip)] text-[var(--color-sd-violet-chip-fg)]",
  },
  teal: {
    card: "bg-[var(--color-sd-teal-card)]",
    border: "border-[var(--color-sd-teal-border)]",
    title: "text-[var(--color-sd-teal-title)]",
    body: "text-[var(--color-sd-teal-body)]",
    chip: "bg-[var(--color-sd-teal-chip)] text-[var(--color-sd-teal-chip-fg)]",
  },
  emerald: {
    card: "bg-[var(--color-sd-emerald-card)]",
    border: "border-[var(--color-sd-emerald-border)]",
    title: "text-[var(--color-sd-emerald-title)]",
    body: "text-[var(--color-sd-emerald-body)]",
    chip: "bg-[var(--color-sd-emerald-chip)] text-[var(--color-sd-emerald-chip-fg)]",
  },
};
