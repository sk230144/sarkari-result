  ...
  return (
    <div className="flex flex-col gap-5 rounded-2xl border border-[var(--color-c-border)] bg-[var(--color-c-surface-2c)] p-6 shadow-sm lg:p-7">
      <div className="flex flex-col justify-between gap-2 sm:flex-row sm:items-center">
        <div>
          <h2 className="text-[15px] font-bold tracking-tight text-[var(--color-c-text)]">
              ...
              <button
                ...
                className={`mt-0.5 flex h-5 w-5 shrink-0 items-center justify-center rounded-full border transition-colors ${
                  checked
                    ...
                    : "border-[var(--color-c-neutral-9)] text-transparent hover:border-[var(--color-c-emerald)] group-hover:border-[var(--color-c-emerald)]"
                }`}
              >
              ...
              <div className="flex min-w-0 flex-col gap-1">
                <span
                  className={`text-[13px] font-semibold ${
                    checked ? "text-[var(--color-c-text)] line-through decoration-[var(--color-c-accent)]/50" : "text-[var(--color-c-text)]"
                  }`}
                >
                  {item.title}
                </span>
        ...
        >
          <button
            ...
            className={`mt-0.5 flex h-5 w-5 shrink-0 items-center justify-center rounded-full border transition-colors ${
                ...
                ? "border-[var(--color-c-accent)] bg-[var(--color-c-accent)] text-[var(--color-c-green-dim)]"
                : "border-[var(--color-c-neutral-9)] text-transparent hover:border-[var(--color-c-emerald)]"
            }`}
          >
